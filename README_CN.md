...
| **VLA-Arena** | 2025 | 评估视觉-语言-动作模型在170个任务上的表现，包含三个难度级别以及语言和视觉观察的扰动。 | 成功率、对扰动的鲁棒性、超越训练的泛化能力、安全约束遵守、长程任务组合能力。 | 178 | 2026-03 | [论文](https://arxiv.org/abs/2512.22539) · [代码](https://github.com/PKU-Alignment/VLA-Arena) |
| **THE COLOSSEUM** | 2024 | 在20个多样化任务和14个环境扰动轴（包括颜色、纹理、大小、光照、干扰物和相机位姿）上评估机器人操作策略。 | 成功率 | 150 | 2025-03 | [论文](https://arxiv.org/abs/2402.08191) · [代码](https://github.com/robot-colosseum/robot-colosseum) · [主页](https://robot-colosseum.github.io) |
<!-- AEE-TABLE:VLA:END -->
